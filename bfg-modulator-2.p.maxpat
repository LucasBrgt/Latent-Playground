...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 492.0, 76.0, 79.0, 49.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 392.0, 76.0, 105.0, 49.0 ],
					"text" : "active 0, interval $1 ticks, quantize $1 ticks, active 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 292.0, 156.0, 219.0, 22.0 ],
					"text" : "switch 2 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 292.0, 89.0, 84.0, 22.0 ],
					"text" : "fromsymbol"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 292.0, 57.0, 85.0, 22.0 ],
					"text" : "r ---time-mode"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 83.946238100528717, 908.256804943084717, 48.0, 22.0 ],
					"text" : "r ---rate"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 139.449529647827148, 103.669716119766235, 49.0, 22.0 ],
					"text" : "!/ 1000."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 34.946238100528717, 950.458636283874512, 68.0, 22.0 ],
					"text" : "onepole~ 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 127.0, 211.0, 54.0, 22.0 ],
					"text" : "r ---reset"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 392.0, 482.5, 134.0, 23.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 392.0, 455.0, 77.0, 22.0 ],
					"text" : "r ---attr-basis"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 127.0, 808.0, 89.0, 22.0 ],
					"text" : "r ---pong-mode"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 95.0, 837.0, 100.0, 22.0 ],
					"text" : "pong -3. 3."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 176.0, 265.137592554092407, 61.0, 22.0 ],
					"text" : "r ---speed"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 290.0, 455.0, 56.0, 22.0 ],
					"text" : "r ---basis"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 35.0, 861.0, 79.0, 22.0 ],
					"text" : "gate"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 35.0, 990.0, 80.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 34.946238100528717, 908.256804943084717, 44.0, 22.0 ],
					"text" : "sig~ 0."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 290.0, 483.0, 93.0, 22.0 ],
					"text" : "prepend basis"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 96.0, 605.0, 117.0, 23.0 ],
					"text" : "jit.normalize"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 95.0, 777.0, 244.0, 22.0 ],
					"text" : "expr ($f1 * 2. - 1.) * $f2 +$f3"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 5,
					"outlettype" : [ "", "", "", "", "" ],
					"patching_rect" : [ 95.0, 712.0, 83.0, 22.0 ],
					"text" : "unjoin 4"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 96.0, 639.0, 117.0, 22.0 ],
					"text" : "jit.spill"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "bang", "" ],
					"patching_rect" : [ 96.0, 438.0, 29.5, 22.0 ],
					"text" : "t b l"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 95.0, 404.0, 100.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 96.0, 573.0, 117.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 320.0, 736.0, 149.0, 22.0 ],
					"saved_object_attributes" : 					{
						"attr_comment" : "offset"
					}
,
					"text" : "in 4 @attr_comment offset"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 207.5, 712.0, 148.0, 22.0 ],
					"saved_object_attributes" : 					{
						"attr_comment" : "scale"
					}
,
					"text" : "in 3 @attr_comment scale"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 127.0, 276.0, 29.5, 22.0 ],
					"text" : "0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 176.0, 306.0, 45.0, 22.0 ],
					"text" : "/ 1000."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "int", "", "", "int" ],
					"patching_rect" : [ 95.0, 306.0, 61.0, 22.0 ],
					"text" : "counter"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 95.0, 356.0, 100.0, 22.0 ],
					"text" : "* 0.5"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 139.0, 63.0, 48.0, 22.0 ],
					"text" : "r ---rate"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 95.0, 151.0, 63.0, 22.0 ],
					"text" : "qmetro 40"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 95.0, 62.0, 24.0, 24.0 ],
					"svg" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 392.0, 24.0, 179.0, 22.0 ],
					"saved_object_attributes" : 					{
						"attr_comment" : "subdivision"
					}
,
					"text" : "in 2 @attr_comment subdivision"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 238.0, 24.0, 146.0, 22.0 ],
					"saved_object_attributes" : 					{
						"attr_comment" : "seed"
					}
,
					"text" : "in 1 @attr_comment seed"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 238.0, 229.0, 51.0, 22.0 ],
					"text" : "seed $1"
				}
...
, 			{
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"midpoints" : [ 44.5, 903.31732177734375, 44.446238100528717, 903.31732177734375 ],
					"source" : [ "obj-1", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-1", 0 ],
					"midpoints" : [ 104.5, 129.53033447265625, 44.5, 129.53033447265625 ],
					"order" : 1,
					"source" : [ "obj-108", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 301.5, 218.75, 247.5, 218.75 ],
					"source" : [ "obj-109", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-117", 0 ],
					"midpoints" : [ 247.5, 175.500000043487546, 247.5, 175.500000043487546 ],
					"source" : [ "obj-11", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 247.5, 263.500000021743745, 136.5, 263.500000021743745 ],
					"order" : 0,
					"source" : [ "obj-117", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 247.5, 474.413757345962495, 105.5, 474.413757345962495 ],
					"order" : 1,
					"source" : [ "obj-117", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-41", 0 ],
					"midpoints" : [ 116.0, 510.868556956512407, 105.5, 510.868556956512407 ],
					"source" : [ "obj-39", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-41", 0 ],
					"midpoints" : [ 105.5, 510.868556956512407, 105.5, 510.868556956512407 ],
					"source" : [ "obj-39", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-41", 0 ],
					"midpoints" : [ 299.5, 523.78594970703125, 105.5, 523.78594970703125 ],
					"source" : [ "obj-43", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-41", 0 ],
					"midpoints" : [ 401.5, 526.3690185546875, 105.5, 526.3690185546875 ],
					"source" : [ "obj-63", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 401.5, 61.0, 501.5, 61.0 ],
					"order" : 0,
					"source" : [ "obj-8", 0 ]
				}
