...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 127.0, 211.0, 43.0, 22.0 ],
					"text" : "r reset"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 392.0, 455.0, 65.0, 22.0 ],
					"text" : "r attr-basis"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 164.75, 939.0, 177.0, 22.0 ],
					"saved_object_attributes" : 					{
						"attr_comment" : "slide-down"
					}
,
					"text" : "in 6 @attr_comment slide-down"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 127.0, 808.0, 77.0, 22.0 ],
					"text" : "r pong-mode"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 176.0, 100.0, 49.0, 22.0 ],
					"text" : "r speed"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 290.0, 455.0, 44.0, 22.0 ],
					"text" : "r basis"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 35.0, 878.0, 79.0, 22.0 ],
					"text" : "gate"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 94.75, 1003.0, 32.0, 22.0 ],
					"text" : "out~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 94.75, 915.0, 31.0, 22.0 ],
					"text" : "sig~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 94.75, 966.0, 89.0, 22.0 ],
					"text" : "slide~ 0 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 129.75, 915.0, 162.0, 22.0 ],
					"saved_object_attributes" : 					{
						"attr_comment" : "slide-up"
					}
,
					"text" : "in 5 @attr_comment slide-up"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 96.0, 590.0, 78.0, 23.0 ],
					"text" : "jit.normalize"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 5,
					"outlettype" : [ "", "", "", "", "" ],
					"patching_rect" : [ 95.0, 664.0, 83.0, 22.0 ],
					"text" : "unjoin 4"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 96.0, 627.0, 41.0, 22.0 ],
					"text" : "jit.spill"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "jit_matrix", "" ],
					"patching_rect" : [ 96.0, 540.0, 117.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 207.5, 704.0, 148.0, 22.0 ],
					"saved_object_attributes" : 					{
						"attr_comment" : "scale"
					}
,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 95.0, 31.0, 46.0, 22.0 ],
					"text" : "r on/off"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 95.0, 85.0, 24.0, 24.0 ],
					"svg" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 392.0, 100.0, 49.0, 22.0 ],
					"text" : "$1 ticks"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 290.0, 100.0, 71.0, 22.0 ],
					"text" : "quantize $1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 392.0, 63.0, 179.0, 22.0 ],
					"saved_object_attributes" : 					{
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 238.0, 63.0, 146.0, 22.0 ],
					"saved_object_attributes" : 					{
						"attr_comment" : "seed"
					}
,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 290.0, 155.0, 121.0, 23.0 ],
		...
		"lines" : [ 			{
				"patchline" : 				{
					...
					"midpoints" : [ 44.5, 903.31732177734375, 104.25, 903.31732177734375 ],
					"source" : [ "obj-1", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 299.5, 202.750000043487546, 247.5, 202.750000043487546 ],
					"source" : [ "obj-109", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-41", 0 ],
					"midpoints" : [ 401.5, 525.3690185546875, 105.5, 525.3690185546875 ],
					"source" : [ "obj-63", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 401.5, 92.000000043487546, 299.5, 92.000000043487546 ],
					"order" : 1,
					"source" : [ "obj-8", 0 ]
				}
