...
function clear() {
	_bgcolor = [0.95,0.95,0.95,0.95, 0.];
	_shape = 'circle'
...
function click(normX, normY) {
    ...
    const screenY = (1 - normY) * height; // Inverser l’axe Y

    // Appelle la fonction ondrag comme si clic souris
    ondrag(screenX, screenY, 1, 0, 0, 0, 0, 0);
    clickstart = { x:screenX, y:screenY }
}
